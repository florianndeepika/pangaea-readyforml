...
app = FastAPI(
    ...
    description=(
        "Evaluate any PANGAEA earth science dataset "
        "for Machine Learning and Data Science suitability."
    ),
    version="0.1.0",
    contact={
        "name": "Your Name",
        "url": "https://github.com/yourusername/pangaea-readiness",
    },
    license_info={
        "name": "MIT",
    }
